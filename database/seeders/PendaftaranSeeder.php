    ...
    public function run(): void
    {
        $pendaftaran = [
            [
                ...
                'slug' => Str::slug('Informasi Pendaftaran Peserta Didik Baru Tahun Ajaran 2025/2026'),
                ...
                'tanggal_selesai' => Carbon::create(2025, 6, 15),
                'link_pendaftaran' => 'https://ppdb.sdn-medokanayu2.sch.id',
                'kontak_pendaftaran' => '(031) 8782337',
                'is_active' => true,
            ],
            [
                'judul' => 'Informasi Pendaftaran Peserta Didik Baru Tahun Ajaran 2024/2025',
                'slug' => Str::slug('Informasi Pendaftaran Peserta Didik Baru Tahun Ajaran 2024/2025'),
                ...
                'tanggal_selesai' => Carbon::create(2024, 6, 15),
                'link_pendaftaran' => 'https://ppdb.sdn-medokanayu2.sch.id',
                'kontak_pendaftaran' => '(031) 8782337',
                'is_active' => true,
            ],
            [
                ...
                'slug' => Str::slug('Informasi Pendaftaran Peserta Didik Baru Tahun Ajaran 2023/2024'),
                ...
                'tanggal_mulai' => Carbon::create(2023, 6, 1),
                'tanggal_selesai' => Carbon::create(2023, 6, 15),
                'link_pendaftaran' => 'https://ppdb.sdn-medokanayu2.sch.id',
                'kontak_pendaftaran' => '(031) 8782337',
                'is_active' => true,
            ],
