...
@section('header')
<!-- Home page uses a different header with slider, so we override the header section -->
<header>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="{{ asset('images/slider.jpg') }}" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="{{ asset('images/slider-2.jpg') }}" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="{{ asset('images/slider-3.jpg') }}" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-5">
                    <div class="course-img-wrap">
                        <img src="{{ asset('images/courses_1.jpg') }}" class="img-fluid" alt="courses-img">
                        <div class="courses_box-img">
                            <div class="courses-link-wrap">
                                <a href="{{ url('/course-detail') }}" class="course-link"><span>course Details </span></a>
                                <a href="{{ url('/admission-form') }}" class="course-link"><span>Join today </span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="{{ url('/course-detail') }}" class="course-box-content">
                        <h3>Biochemistry</h3>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-5">
                    <div class="course-img-wrap">
                        <img src="{{ asset('images/courses_2.jpg') }}" class="img-fluid" alt="courses-img">
                        <div class="courses_box-img">
                            <div class="courses-link-wrap">
                                <a href="{{ url('/course-detail') }}" class="course-link"><span>course Details </span></a>
                                <a href="{{ url('/admission-form') }}" class="course-link"><span>Join today </span></a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-5">
                    <div class="course-img-wrap">
                        <img src="{{ asset('images/courses_3.jpg') }}" class="img-fluid" alt="courses-img">
                        <div class="courses_box-img">
                            <div class="courses-link-wrap">
                                <a href="{{ url('/course-detail') }}" class="course-link"><span>course Details </span></a>
                                <a href="{{ url('/admission-form') }}" class="course-link"><span>Join today </span></a>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div class="courses_box mb-5">
                    <div class="course-img-wrap">
                        <img src="{{ asset('images/courses_4.jpg') }}" class="img-fluid" alt="courses-img">
                        <div class="courses_box-img">
                            <div class="courses-link-wrap">
                                <a href="{{ url('/course-detail') }}" class="course-link"><span>course Details </span></a>
                                <a href="{{ url('/admission-form') }}" class="course-link"><span>Join today </span></a>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="event-img">
                    ...
                    <img src="{{ asset('images/upcoming-event-img.jpg') }}" class="img-fluid" alt="event-img">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom">
                ...
                <div class="chart-text">
                    <p><span class="counter">39</span> Teachers</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom chart_top">
                ...
                <div class="chart-text">
                    <p><span class="counter">2600</span> Students</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-3 chart_top">
                ...
                <div class="chart-text">
                    <p><span class="counter">56</span> Courses</p>
                </div>
            </div>
...
<section class="blog">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                <a href="{{ url('/blog-post') }}" class="home_blog_link">
                    <div class="blog-img_box">
                        <img src="{{ asset('images/blog-img_1.jpg') }}" class="img-fluid blog_display" alt="blog-img">
                        <div class="blogtitle">
            ...
            <div class="col-md-4">
                <a href="{{ url('/blog-post') }}" class="home_blog_link">
                    <div class="blog-img_box">
                        <img src="{{ asset('images/blog-img_2.jpg') }}" class="img-fluid blog_display" alt="blog-img">
                        <div class="blogtitle">
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="{{ url('/blog-post') }}" class="home_blog_link">
                    <div class="blog-img_box">
                        <img src="{{ asset('images/blog-img_3.jpg') }}" class="img-fluid blog_display" alt="blog-img">
                        <div class="blogtitle">
                ...
                <a href="{{ url('/blog-post') }}" class="home_blog_link">
                    <div class="blog-img_box">
                        <div class="blog-video">
                            <div class="blog-play_btn"> <img src="{{ asset('images/play-btn.png') }}" alt="play-btn"> </div>
                            <img src="{{ asset('images/blog-img_4.jpg') }}" class="img-fluid blog_display" alt="blog-img">
                        </div>
                        <div class="blogtitle">
