...
<section class="welcome_about">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <img src="{{ asset('images/welcome-img.jpg') }}" class="img-fluid" alt="#">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="single-item">
                    <div class="quote">
                        ...
                        <div class="testi-img_block">
                            <img src="{{ asset('images/testi-img.jpg') }}" class="img-fluid" alt="#">
...
<section class="our-teachers">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('images/our-teachers_03.jpg') }}" class="img-fluid teachers-img" alt="#">
                    <div class="teachers-description">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="our-teachers-block">
                    <img src="{{ asset('images/our-teachers_04.jpg') }}" class="img-fluid teachers-img" alt="#">
                    <div class="teachers-description">
