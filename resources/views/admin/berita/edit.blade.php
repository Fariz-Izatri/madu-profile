                ...
                <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="kategori_id" name="kategori_id">
                                ...
                                @foreach($kategori as $kat)
                                    <option value="{{ $kat->id }}" {{ (old('kategori_id', $berita->kategori_id) == $kat->id) ? 'selected' : '' }}>{{ $kat->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $berita->tanggal->format('Y-m-d')) }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="konten" name="konten" rows="6" required>{{ old('konten', $berita->konten) }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_populer" name="is_populer" {{ (old('is_populer', $berita->is_populer)) ? 'checked' : '' }}>
