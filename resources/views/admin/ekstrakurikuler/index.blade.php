                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $index + $ekstrakurikuler->firstItem() }}</td>
                                    <td>{{ $item->nama }}</td>
                                    <td>{{ $item->pembina ?? '-' }}</td>
                                    <td>{{ $item->jadwal ?? '-' }}</td>
                                    <td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.ekstrakurikuler.edit', $item->id) }}" class="btn btn-info btn-sm">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.ekstrakurikuler.destroy', $item->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus ekstrakurikuler ini?')">
                                            @csrf
                                            @method('DELETE')
